...
class TestStop(base.TestCase):
    ...
    def test_pre_condition_instance_not_found(self):
        ...
        exc = self.assertRaises(
            exception.InstanceNotFound, self.action.pre_condition)
    ...
    def test_execute_instance_not_found(self):
        self.m_helper.find_instance.return_value = None
    ...
    def test_execute_stop_failure(self):
        self.m_helper.find_instance.return_value = self.INSTANCE_UUID
    ...
    def test_post_condition_instance_stopped(self):
        instance = mock.Mock()
        instance.status = 'stopped'
        self.m_helper.find_instance.return_value = instance

        result = self.action.post_condition()

        self.assertTrue(result)
        self.m_helper.find_instance.assert_called_once_with(self.INSTANCE_UUID)
        self.m_helper.wait_for_instance_state.assert_not_called()

    def test_post_condition_instance_not_found(self):
        self.m_helper.find_instance.return_value = None
    ...
    def test_post_condition_instance_not_stopped_wait_success(self):
        instance = mock.Mock()
        instance.status = 'active'
        self.m_helper.find_instance.return_value = instance
        self.m_helper.wait_for_instance_state.return_value = True

        result = self.action.post_condition()

        self.assertTrue(result)
        self.m_helper.wait_for_instance_state.assert_called_once_with(
            instance, 'stopped', 8, 10)

    def test_post_condition_instance_not_stopped_wait_timeout(self):
        instance = mock.Mock()
        instance.status = 'active'
        self.m_helper.find_instance.return_value = instance
        self.m_helper.wait_for_instance_state.return_value = False
    ...
    def test_post_condition_nova_exception(self):
        self.m_helper.find_instance.side_effect = Exception("Nova error")
